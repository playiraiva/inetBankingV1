...
public class TC_DeleteCustTest_006 extends BaseTest{
	...
	public void editCust() {
		...
		logger.info("Edited Cust Successfully..!!");
		ec.homeBtn();
	...
	public void deleteCust() {
		dc = new DeleteCustPage(driver);
		dc.deleteCustLink();
		logger.info("Clicked On Delete Cust link");
		logger.info("Delete Acc Form Displayed");
		dc.cidTxt(cid);
		logger.info("Entered Cid into Delete Form");
		logger.info("Deleted Cust Successfully..!!");
		
	}
	
	@Test(dependsOnMethods= {"login","addCust","editCust","deleteCust"})
	public void logout() {
